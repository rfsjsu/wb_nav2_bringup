...
class YOLODetectorNode(Node):
    def __init__(self):
        ...
        self.model.set_classes([
            ...
            "empty wooden shipping pallet",

            # Barrels
            "red barrel",
            "blue barrel",
            "red industrial metal barrel",
            "blue industrial metal barrel",
            "stack of red industrial barrels",
            "stack of blue industrial barrels",

            # Boxes
            "box",
            "stack of cardboard boxes",
            "brown cardboard shipping box",
            "stacked shipping boxes on pallet",

            # Storage / structure
            "metal warehouse storage rack",
        ...
        # Subscribe to top forklift camera
        self.image_sub = self.create_subscription(
            Image,
            '/top/depth_camera/image_raw',
            self.image_callback,
            10
        )
        ...
        self.get_logger().info('Subscribed to: /top/depth_camera/image_raw')
    ...
    def image_callback(self, msg):
        try:
            ...
            # Log detections to view in terminal
